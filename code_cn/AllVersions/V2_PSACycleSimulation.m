function [ objectives, constraints ] = V2_PSACycleSimulation( x, material, type, N)
    ...
    process_variables = [1.0, x(1), x(1)*x(4)/8.314/313.15,  x(2),  x(3),  x(5), 1e4, x(6), x(7), x(8)] ;
	
	try
    [objectives, constraints] = V2_PSACycle(process_variables, material, [], type, N) ;
	catch
