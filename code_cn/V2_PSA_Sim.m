...
% --- 定义随机采样变量 x 的边界 ---
lb = [1e5,  10, 0.01, 0.1, 0, 1e4, 0, 0];      % x 的下界
ub = [10e5, 1000, 0.99, 2, 1, 5e4, 20, 30];     % x 的上界
...
X_samples = [
220676, 47.902,	0.236211,	0.16219,	0.529994,	10673.4,	15.4153,	17.1233
];
...
for i = 1:num_simulations
    ...
    % 调用仿真函数 (请替换为您的真实函数)
    [objectives, constraints] = V2_PSACycleSimulation(x, material, type, N);
